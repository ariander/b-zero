          ...
          <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-4 gap-12 text-sm">
            <div className="md:col-span-2">
              ...
              <div className="hidden md:block">
                ...
                <ul className="space-y-3 font-semibold">
                  ...
                  <li><Link href="/shims-kalkulator" className="hover:text-brand-red transition flex items-center gap-2"><ArrowRight size={14} className="text-neutral-600" /> Shims-kalkulator <span className="text-[10px] font-bold uppercase tracking-wide text-brand-red border border-brand-red/50 rounded px-1.5 py-0.5">Beta</span></Link></li>
            ...
            <div>
              ...
              <ul className="space-y-4 font-semibold">
                ...
                <li><Link href="/byggeguide" className="hover:text-brand-red transition flex items-center gap-2"><ArrowRight size={14} className="text-neutral-600" /> Byggeguide</Link></li>
