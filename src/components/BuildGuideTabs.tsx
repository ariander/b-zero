                            ...
                            <div className="space-y-12 [&_p]:text-slate-700 [&_p]:leading-relaxed [&_li]:text-slate-700 [&_li]:leading-relaxed [&_strong]:text-slate-900">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/External-Master-Switch-Pulls-450x450.jpg')}>
                                            <Image src="/External-Master-Switch-Pulls-450x450.jpg" alt="Master Switch Pull" width={450} height={450} className="w-full object-cover hover:scale-105 transition-transform" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200 w-fit" onClick={() => setZoomedImage('/Fuel Tank Protector.jpg')}>
                                        <Image src="/Fuel Tank Protector.jpg" alt="Fuel Tank Protector" width={800} height={400} className="hover:scale-105 transition-transform" />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/Brake Pipe Guard 1.jpg')}>
                                            <Image src="/Brake Pipe Guard 1.jpg" alt="Brake Pipe Guard" width={500} height={350} className="hover:scale-105 transition-transform w-full object-cover" />
                                        </div>
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/Brake Pipe Guard 2.jpg')}>
                                            <Image src="/Brake Pipe Guard 2.jpg" alt="Brake Pipe Guard" width={500} height={350} className="hover:scale-105 transition-transform w-full object-cover" />
                                        </div>
                                    </div>

                                    <h3 id="drive-by-wire" className="font-bold text-xl text-slate-900 mt-10 mb-2 pt-6 border-t border-slate-200">
                                        For biler med elektronisk gasspjeld: Den offisielle måten å fjerne motorkutt ved brems
                                    </h3>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/IMG_8611.avif')}>
                                            <Image src="/IMG_8611.avif" alt="Drive by wire fix 1" width={400} height={400} className="object-cover w-full h-full hover:scale-105 transition-transform" />
                                        </div>
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/IMG_8612.avif')}>
                                            <Image src="/IMG_8612.avif" alt="Drive by wire fix 2" width={400} height={400} className="object-cover w-full h-full hover:scale-105 transition-transform" />
                                        </div>
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/IMG_8613.avif')}>
                                            <Image src="/IMG_8613.avif" alt="Drive by wire fix 3" width={400} height={400} className="object-cover w-full h-full hover:scale-105 transition-transform" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li><strong>Dekk (Asfalt/Racing):</strong> I asfaltløp brukes klassens dedikerte Nankang enhetsdekk for asfalt. 14-tommer. Greit utgangspunkt for lufttrykk på tørr asfalt er 26–27 PSI fremme, og 27–29 PSI bak. Dette varierer selvsagt med underlag, kjørestil og temperatur. Sjekk trykket etter noen raske runder; ligger du på rundt 33-34 PSI er det bra. Hvis ikke, juster varme dekk til rundt 34 PSI . Er det regn, lønner det seg å gå opp en del i trykk, for eksempel 34-37 PSI fremme og 37-39 PSI bak. Dekkene får ikke samme arbeidstemperatur i regn, og må ha høyere trykk for å kompensere.</li>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/Right Extended Driveshaft.jpg')}>
                                            <Image src="/Right Extended Driveshaft.jpg" alt="Extended Driveshaft" width={300} height={300} className="hover:scale-105 transition-transform w-full object-cover" />
                                        </div>
                                        <div className="cursor-pointer overflow-hidden rounded-xl border border-slate-200" onClick={() => setZoomedImage('/Track Rod Extension 450.jpg')}>
                                            <Image src="/Track Rod Extension 450.jpg" alt="Track Rod Extension" width={300} height={300} className="hover:scale-105 transition-transform w-full object-cover" />
                                        </div>
                                    </div>
                                </div>
